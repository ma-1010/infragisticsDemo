...
/****** Object:  Database [MVVMLoginDb]    Script Date: 4/10/2023 2:36:53 PM ******/
CREATE DATABASE [MVVMLoginDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MVVMLoginDb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\MVVMLoginDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'MVVMLoginDb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\MVVMLoginDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [MVVMLoginDb] SET  DISABLE_BROKER 
GO
